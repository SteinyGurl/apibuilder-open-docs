...
![Single cluster
configuration](/Images/apim-reference-architectures/container-aws/image2.jpg)
...
architecture](/Images/apim-reference-architectures/container-aws/image3.png)
...
**podAntiAffinity**. You should instruct Kubernetes _not_ to
...
request processing. The learn how to create and
...
![Building Docker images](/Images/apim-reference-architectures/container-aws/image9.tmp)
...
`APIGateway_7.7-1_DockerScripts.tar.gz`
...
The build process will be identical to the one described in new configurations.

#### Upgrading the product

Upgrading your existing deployment to a new version of AMPLIFY API
Management will be similar to a process described in new
